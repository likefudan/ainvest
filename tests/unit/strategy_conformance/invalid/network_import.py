"""Network import strategy — fails network static scan."""
...
class NetworkImportStrategy:
    name: ClassVar[str] = "invalid_network"
    ...
    def evaluate(self, context: StrategyContext) -> StrategyResult:
        ...
        socket.gethostname()
        return StrategyResult(diagnostics=StrategyDiagnostics(notes=("network",)))

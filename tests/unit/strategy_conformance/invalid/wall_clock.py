"""Wall-clock strategy — fails no_future_data."""
...
class WallClockStrategy:
    name: ClassVar[str] = "invalid_wall_clock"
    ...
    def evaluate(self, context: StrategyContext) -> StrategyResult:
        ...
        return StrategyResult(diagnostics=StrategyDiagnostics(notes=("wall-clock",)))

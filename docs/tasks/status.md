...
`src/ainvest/db/uow.py`, `tests/unit/approval/test_service.py`,
...
| Task | Status | Dependencies / unlock | Allowed implementation scope |
|---|---|---|---|
| `P05-T0` | `in_progress` | `P02-T3`, `P02-T4`, `P02-T6`–`P02-T9` | `approval/{service,tokens}.py`, approval re-exports, `schemas/approval.py`, `db/{repositories,uow}.py`, `tests/unit/approval/test_{service,tokens}.py`; generated ApprovalChallenge schema + manifest only |
